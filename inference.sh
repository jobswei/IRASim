...
# Usage:
#   bash inference.sh <checkpoint_path> [start_index] [max_samples] [output_dir] [num_inference_steps]
#
# Example:
#   bash inference.sh results/03/21/libero_frame_ada/checkpoints/0000500.pt 0 1 work_dirs/inference/libero/0000500 50
